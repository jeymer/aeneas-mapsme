...
echo "MAPSME_TASK_INTERVAL=30000=int" >> $hdir/stoke_properties.txt
...
am start -n com.mapswithme.maps.pro.experiment/com.mapswithme.maps.DownloadResourcesActivity > /dev/null
