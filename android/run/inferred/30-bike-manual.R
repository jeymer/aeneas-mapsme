...
for (i in c("0")) {
  ...
  plot <- 
    ...
    annotate("rect", xmin = 1, xmax = 30, ymin = 49, ymax = Inf, fill = "yellow", alpha = 0.50) +
    annotate("text", x=10,y=52,label="Warmup") +

    # Tighten Box
    annotate("rect", xmin = 31, xmax = 65, ymin = 49, ymax = Inf, fill = "blue", alpha = 0.50) +
    annotate("text", ,x=45,y=52,label="Tighten") +

    # Cross Box
    annotate("rect", xmin = 66, xmax = 96, ymin = 49, ymax = Inf, fill = "red", alpha = 0.50) +
    annotate("text", x=75,y=52,label="Cross") +

    # Tighten Box
    annotate("rect", xmin = 97, xmax = 121, ymin = 49, ymax = Inf, fill = "blue", alpha = 0.50) +
    annotate("text", ,x=110,y=52,label="Tighten") +
