...
for i in `seq 0 ${samples_len}`; do
  ...
  rm online-table-sall-experiment/mapsme.$sample.log
  touch online-table-sall-experiment/mapsme.$sample.log
  ...
  for r in `seq 0 $runs`; do
    ...
    cat /sdcard/stoke/stoke.log >> online-table-sall-experiment/mapsme.$sample.log
