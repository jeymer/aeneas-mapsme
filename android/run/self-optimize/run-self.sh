...
echo "STOKE_STOCHASTIC_POLICY=VBDE_05=string" >> $hdir/stoke_properties.txt
...
echo "STOKE_NUM_SELF_OPTIMIZE_TICKS=8=int" >> $hdir/stoke_properties.txt 
echo "STOKE_NUM_SELF_OPTIMIZE_ROUNDS=4=int" >> $hdir/stoke_properties.txt 
