...
for (i in c("1")) {
  ...
  plot <- 
    ...
    annotate("text", x=22,y=52,label="Warmup") +

    # Tighten Box
    annotate("rect", xmin = 31, xmax = 60, ymin = 49, ymax = Inf, fill = "blue", alpha = 0.50) +
    annotate("text", ,x=40,y=52,label="Tighten") +

    # Tighten Box
    annotate("rect", xmin = 61, xmax = 121, ymin = 49, ymax = Inf, fill = "blue", alpha = 0.505) +
    annotate("text", x=70,y=52,label="Tighten") +
