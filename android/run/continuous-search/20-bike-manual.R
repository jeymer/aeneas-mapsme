...
for (i in c("0")) {
  ...
  plot <- 
    ...
    # Tighten Box
    annotate("rect", xmin = 31, xmax = 60, ymin = 48, ymax = Inf, fill = "blue", alpha = 0.50) +
    annotate("text", x=42,y=49.5,label="Tighten") +

    # Tighten Box
    annotate("rect", xmin = 61, xmax = 121, ymin = 48, ymax = Inf, fill = "blue", alpha = 0.50) +
    annotate("text", x=72,y=49.5,label="Tighten") +

    # Cross Box
    #annotate("rect", xmin = 62, xmax = 92, ymin = 48, ymax = Inf, fill = "green", alpha = 0.50) +
    #annotate("text", x=72,y=49.5,label="Widen") +

    # Cross Box
    #annotate("rect", xmin = 93, xmax = 120, ymin = 48, ymax = Inf, fill = "blue", alpha = 0.50) +
