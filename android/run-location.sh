...
# Setup
echo "STOKE_EXPERIMENT=CONSTRAINED=string" > $hdir/stoke_properties.txt
...
echo "STOKE_REWARD=LOCATION=string" >> $hdir/stoke_properties.txt 

echo "MAPSME_MINLOCATION=0=double" >> $hdir/stoke_properties.txt
